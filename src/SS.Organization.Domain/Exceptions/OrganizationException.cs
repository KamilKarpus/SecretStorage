...
{
    public class OrganizationException : SSException
    {
        private readonly HttpErrorCodes _code;
        private readonly string _message;
        private readonly InternalErrorCodes _internalCode;
        public OrganizationException(string message, HttpErrorCodes code, InternalErrorCodes internalCode) : base(message)
        {
            _code = code;
            _message = message;
